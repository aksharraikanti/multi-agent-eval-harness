...
cost_usd (day 21+) is optional and only meaningful for evaluators that
make a paid API call — rule-based evaluators leave it None, since a
dict lookup or a regex match doesn't cost anything.
"""
